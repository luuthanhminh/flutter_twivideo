...
// ignore: constant_identifier_names
const int NUMERIC_START = 48;
// ignore: constant_identifier_names
const int NUMERIC_END = 57;
// ignore: constant_identifier_names
const int LOWER_ALPHA_START = 97;
// ignore: constant_identifier_names
const int LOWER_ALPHA_END = 122;
// ignore: constant_identifier_names
const int UPPER_ALPHA_START = 65;
// ignore: constant_identifier_names
const int UPPER_ALPHA_END = 90;

/// Generates a random integer where [from] <= [to].
int randomBetween(int from, int to) {
  if (from > to) {
    throw Exception('$from cannot be > $to');
  }
...
String randomString(int length, {int from = ASCII_START, int to = ASCII_END}) {
  return String.fromCharCodes(
      ...
      List.generate(length, (int index) => randomBetween(from, to)));
}
